    ...
    <script>
        function updateTanggalKembali() {
            ...
            if (statusSelect.value === 'Dikembalikan') {
                ...
                tanggalKembaliInput.value = today;
            }
        }
    </script>
</head>
    ...
    <form action="{{ route('transaksi.update', $transaksi->id_transaksi) }}" method="POST">
        ...
        <select name="barang_id" id="barang_id" required>
            @foreach($barangs as $barang)
                <option value="{{ $barang->id_barang }}" {{ $transaksi->barang_id == $barang->id_barang ? 'selected' : '' }}>
        ...
        <select name="status" id="status" required onchange="updateTanggalKembali()">
        ...
        <input type="date" name="tanggal_kembali" id="tanggal_kembali" value="{{ old('tanggal_kembali', $transaksi->tanggal_kembali) }}" required>
        @error('tanggal_kembali') <span class="error-message">{{ $message }}</span> @enderror
